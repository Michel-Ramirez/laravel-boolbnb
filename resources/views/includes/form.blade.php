    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control @error('night_price') is-invalid @enderror"
                id="price" name="night_price" value="{{ old('night_price') }}" min="0">
            @error('night_price')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('total_bath') is-invalid @enderror" id="bath"
                name="total_bath" value="{{ old('total_bath') }}" min="0">
            @error('total_bath')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('total_rooms') is-invalid @enderror" id="rooms"
                name="total_rooms" value="{{ old('total_rooms') }}" min="0">
            @error('total_rooms')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('total_beds') is-invalid @enderror" id="beds"
                name="total_beds" value="{{ old('total_beds') }}" min="0">
            @error('total_beds')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
